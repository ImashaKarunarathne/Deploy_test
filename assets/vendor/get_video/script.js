...
const splitedVideo = document.querySelector('video#onlyVideo');
const splitedAudio = document.querySelector('video#onlyAudio');
const recordButton = document.querySelector('button#record');
const playButton = document.querySelector('button#play');
const downloadButton = document.querySelector('button#download');
const splitButton = document.querySelector('button#split');
...
const downloadVideoButton = document.querySelector('button#downloadVideo');
